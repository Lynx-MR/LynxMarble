...
namespace Lynx.UI
{
    public class LynxSimpleButton : Button
    {
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            if (useTheme && LynxThemeManager.Instance.currentTheme.CallAudioOnPress(out AudioClip clip))
            {
        ...
        public override void OnPointerUp(PointerEventData eventData)
        {
            ...
            if (useTheme && LynxThemeManager.Instance.currentTheme.CallOnAudioUnpress(out AudioClip clip))
            {
                AudioSource.PlayClipAtPoint(clip, Camera.main.transform.position);
            }
